...
class __TwigTemplate_39c10b52ee6a5661217228e1bd389671 extends Template
{
    ...
    <div class=\"card shadow-sm border-0\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            ...
            yield "</td>
                            <td class=\"py-2\">";
            // line 28
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["post"], "publishedAt", [], "any", false, false, false, 28), "medium", "short", "", "UTC"), "html", null, true);
            yield "</td>
                            <td class=\"text-center py-2\">
                                <div class=\"d-flex justify-content-center gap-3\">
                                    <a href=\"";
            // line 31
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_post_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 31)]), "html", null, true);
            yield "\" class=\"btn btn-outline-secondary btn-sm\" aria-label=\"";
            ...
            yield "
                                    ...
                                    <a href=\"";
            // line 34
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_post_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 34)]), "html", null, true);
            yield "\" class=\"btn btn-outline-primary btn-sm\" aria-label=\"";
...
";
    ...
    {
        return array (  267 => 72,  260 => 68,  248 => 61,  242 => 60,  238 => 59,  233 => 56,  220 => 55,  203 => 47,  193 => 43,  189 => 41,  187 => 46,  175 => 35,  169 => 34,  162 => 32,  156 => 31,  150 => 28,  146 => 27,  143 => 26,  138 => 25,  128 => 20,  120 => 17,  115 => 15,  104 => 7,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
                ...
                <table class=\"table table-hover table-striped align-middle\">
                    ...
                    {% for post in posts %}
                        <tr>
                            ...
                            <td class=\"text-center py-2\">
                                <div class=\"d-flex justify-content-center gap-3\">
                                    <a href=\"{{ path('admin_post_show', {id: post.id}) }}\" class=\"btn btn-outline-secondary btn-sm\" aria-label=\"{{ 'action.show'|trans }}\">
                                        {{ component('ux:icon', { name: 'tabler:eye' }) }} {{ 'action.show'|trans }}
                                    </a>
                                    <a href=\"{{ path('admin_post_edit', {id: post.id}) }}\" class=\"btn btn-outline-primary btn-sm\" aria-label=\"{{ 'action.edit'|trans }}\">
