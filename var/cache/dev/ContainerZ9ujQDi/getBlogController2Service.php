...
class getBlogController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.vBCpsnH'] ?? $container->load('get_ServiceLocator_VBCpsnHService'))->withContext('App\\Controller\\BlogController', $container));
