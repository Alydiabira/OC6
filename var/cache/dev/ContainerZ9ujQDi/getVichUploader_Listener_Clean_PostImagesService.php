...
class getVichUploader_Listener_Clean_PostImagesService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.post_images'])) {
            return $container->privates['vich_uploader.listener.clean.post_images'];
        }

        return $container->privates['vich_uploader.listener.clean.post_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('post_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
