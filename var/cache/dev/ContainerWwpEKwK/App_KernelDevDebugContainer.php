...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', (\dirname(__DIR__, 4).'/vendor/symfony/ux-live-component/src/DependencyInjection/../../assets/dist') => '@symfony/ux-live-component', 'assets/' => '', (\dirname(__DIR__, 4).'/vendor/easycorp/easyadmin-bundle/public') => 'bundles/easyadmin'], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
