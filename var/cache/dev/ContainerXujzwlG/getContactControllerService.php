...
class getContactControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.l0cG.ww'] ?? $container->load('get_ServiceLocator_L0cG_WwService'))->withContext('App\\Controller\\ContactController', $container));
